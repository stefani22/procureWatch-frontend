            ...
            <div style={{
                ...
                {loading ? (
                    ...
                    <div style={{ padding: 60, textAlign: "center", color: "#9ca3af" }}>
                        ...
                        <p style={{ fontSize: 14 }}>
                            Run risk evaluation on contracts to generate reports
                        </p>
                    </div>
                ) : (
                    <table style={{ width: "100%", borderCollapse: "collapse" }}>
                        ...
                        <tr style={{ background: "#2563eb" }}>
                            <th style={{ padding: "16px 20px", textAlign: "left", fontSize: 12, fontWeight: 700, color: "white" }}>
                                Contract ID
                            </th>
                            <th style={{ padding: "16px 20px", textAlign: "left", fontSize: 12, fontWeight: 700, color: "white" }}>
                                Subject
                        ...
                        {data.map((item, index) => (
                            ...
                            >
                                <td style={{ padding: "16px 20px", fontSize: 14, fontWeight: 600, color: "#1e3a5f" }}>
                                    #{item.contractId}
                                </td>
                                ...
                                <td style={{ padding: "16px 20px" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                        <div style={{
                                            ...
                                            <div style={{
                                                width: `${Math.min(item.finalRiskScore || 0, 100)}%`,
                                                height: "100%",
                                                background: (item.finalRiskScore || 0) >= 70 ? "#dc2626" : "#f59e0b",
                                                borderRadius: 4
                                            }} />
                                        </div>
                                ...
                                <td style={{ padding: "16px 20px" }}>
                                        <span style={{
                                            ...
                                            fontSize: 12,
                                            fontWeight: 600,
                                            background: item.riskLevel === "CRITICAL" ? "#fef2f2" : "#fff7ed",
                                            color: item.riskLevel === "CRITICAL" ? "#dc2626" : "#c2410c",
                                            border: `1px solid ${item.riskLevel === "CRITICAL" ? "#fecaca" : "#fed7aa"}`
                                        }}>
